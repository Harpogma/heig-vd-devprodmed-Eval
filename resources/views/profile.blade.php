<x-default-layout>
    ...
    <div class="mb-6">
        <h2 class="text-xl font-bold dark:text-white">
            {{ __('ui.profile.moves_heading', ['first_name' => $user->first_name, 'last_name' => $user->last_name]) }}
        </h2>
        <p class="mt-2 text-sm text-gray-500 dark:text-gray-400">
            {{ trans_choice('ui.profile.number_of_moves', count($moves)) }}
        </p>
    </div>
